...
function AccueilComponent_form_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, " VERSION 5 :( ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
SpotifyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SpotifyComponent, selectors: [["app-spotify"]], inputs: { token: "token" }, decls: 17, vars: 0, consts: [[1, "col-lg-8"], [1, "card", "card-chart"], [1, "card-header"], [1, "buscar-caja"], ["type", "text", "name", "", "id", "search-text", "placeholder", "Saisir un titre / artiste", 1, "input-nom"], ["type", "button", 1, "buscar-btn", 3, "click"], [1, "card-body"], [1, "container"], [1, "row"], ["id", "song_0", 1, "col"], ["id", "song_1", 1, "col"], ["id", "song_2", 1, "col"], ["id", "song_3", 1, "col"], ["id", "song_4", 1, "col"], ["id", "song_5", 1, "col"]], template: function SpotifyComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SpotifyComponent_Template_button_click_5_listener() { return ctx.chercherSons(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](6, "Rechercher");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    } }, styles: ["iframe[_ngcontent-%COMP%] {\n  border-radius: 30px;\n}\n\n.col[_ngcontent-%COMP%] {\n  display: inline-block !important;\n}\n.input-nom[_ngcontent-%COMP%] {\n  align-items: center;\n  font-size: 16px;\n  line-height: 40px;\n  font-weight: bold;\n  padding-top: 8px;\n  width: 0px;\n  transition: 0.4s;\n  float: left;\n}\n.buscar-txt[_ngcontent-%COMP%] {\n  border: none;\n  background: none;\n  outline: none;\n  float: left;\n  padding: 0;\n  color: #333;\n  font-size: 16px;\n  transition: 0.4s;\n  line-height: 40px;\n  font-weight: bold;\n}\n\n.buscar-caja[_ngcontent-%COMP%] {\n  top: 8px;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  background: #fff;\n  border-radius: 40px;\n  padding: 10px;\n}\n.buscar-caja[_ngcontent-%COMP%]:hover    > .buscar-txt[_ngcontent-%COMP%] {\n  width: 240px;\n  padding: 0 6px;\n}\n.buscar-caja[_ngcontent-%COMP%]:hover    > .buscar-btn[_ngcontent-%COMP%] {\n  background: white;\n  color: black;\n}\n.buscar-btn[_ngcontent-%COMP%] {\n  float: right;\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  transition: 0.4s;\n  color: #1DB954;\n  cursor: pointer;\n}\n.buscar-btn[_ngcontent-%COMP%]    > i[_ngcontent-%COMP%] {\n  font-size: 18px;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background: #fff;\n  color: #CB356B;\n  border: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
