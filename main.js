...
function AccueilComponent_form_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, " VERSION 2 AUDIO ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
SpotifyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SpotifyComponent, selectors: [["app-spotify"]], inputs: { token: "token" }, decls: 16, vars: 0, consts: [[1, "col-lg-10"], [1, "card", "card-chart"], [1, "card-header"], [1, "buscar-caja"], ["type", "text", "name", "", "id", "search-text", "placeholder", "Search .....", 1, "buscar-txt"], ["type", "button", 1, "btn-default", "animation-on-hover", 3, "click"], [1, "card-body"], ["id", "song-list", 1, "container"], [1, "row"], ["id", "song_0", 1, "col"], ["id", "song_1", 1, "col"], ["id", "song_2", 1, "col"], ["id", "song_3", 1, "col"], ["id", "song_4", 1, "col"], ["id", "song_5", 1, "col"]], template: function SpotifyComponent_Template(rf, ctx) { if (rf & 1) {
